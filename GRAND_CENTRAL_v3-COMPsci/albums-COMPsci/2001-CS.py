...
b1 = Button(window, text="                         Stil D.R.E (Feat. Snoop Dogg)                       ", command=option4)
b1.pack()
...
b1 = Button(window, text="                          Light Speed (Feat. Hittman)                        ", command=option1)
b1.pack()
...
b1 = Button(window, text="Some L.A. Niggaz (Feat. Hittman, Ms Roq, Knoc-Turn'al, Time Bomb, Koka Kambon, Defari, MC Ren & Xzibit)", command=option17)
b1.pack()
...
def option22():
    ...
    song.play()
    time.sleep(330)
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\albums\\2001.py")
    window.destroy()
    pyglet.app.run()

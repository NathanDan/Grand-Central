...
l0 = Label(window, text="",bg="red3")
l0.pack()

album = ImageTk.PhotoImage(Image.open("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\albums\\R.E.D.jpg"))

label = Label(window, image=album)
label.pack()

l2 = Label(window, text="",bg="red3")
l2.pack()


l2 = Label(window, text="The Game - The R.E.D Album",font='Helvetica 18 bold',bg="red3")
l2.pack()

l1 = Label(window, text="",bg="red3")
l1.pack()
...
b1 = Button(window, text="          The Good, The Bad, The Ugly       ", command=option9)
b1.pack()
...
window.title("The R.E.D Album - MSTR")

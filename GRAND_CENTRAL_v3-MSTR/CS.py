#Nathan Jones
#GRAND CENTRAL v3 - CHATROOM SERVER
#2018
...
print(('GRAND CENTRAL Server')+Style.BRIGHT+Fore.GREEN+str(' ONLINE')+Style.RESET_ALL+str('...')) #SHOWING THAT THE SERVER IS ON
...
There are four commands in Messenger:

@online = Shows all the people currently online

@disconnect = To end your session and disconnect

@all = To send your message to everyone currently online

Add the name of the person at the end of your message preceded by @ to send it to particular person
    ...
    while clientConnected:              #WHILST THE USERS CHATROOM CLIENTS ARE CONNECTED THEN THE FOLLOWING WILL TAKE PLACE 
        ...
        try:
            ...
            if '@online' in msg:   #IF A CHATROOM CLIENT MESSAGE CONTAINS '@online' THEN THE FOLLOWING WILL TAKE PLACE
                ...
                for uname in keys:       
                    if('@'+name) in msg:   #IF A MESSAGE WITHIN THE CHATROOM CONTAINS A NAME OF ONE OF THE USERS IT WILL SEND IT TO THAT USER

...
l0 = Label(window, text="ARTISTS - BOWLING FOR SOUP",font='Helvetica 16 bold' ,bg="gray84") #GIVING THE WINDOW A TITLE SO THE USER/CLIENT KNOWS WHAT MENU THEY ARE ON 
...
l1 = Label(window, text="""Bowling for Soup is an American rock band originally
formed in Wichita Falls, Texas, in 1994. The band consists of
Jaret Reddick, Chris Burney, Gary Wiseman, and Rob Felicetti.
The band is best known for its singles "Girl All the Bad Guys Want",
"1985", "Almost", and "High School Never Ends".
...
def option1():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\ARTISTS\\ALBUMS - BOWLING FOR SOUP\\BFS.py")#TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy() #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU

b1 = Button(window, text=" Bowling For Soup - The Songs People Actually Liked ", command=option1) #CREATING THE BUTTON AND ADDING THE ARTIST AND ALBUM NAME
...
window.title("BOWLING FOR SOUP MAIN MENU - MSTR")    #GIVING THE WINDOW A TITLE THAT WILL BE AT THE VERY TOP ALONGSIDE THE '- O X' BUTTONS 

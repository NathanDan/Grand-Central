...
l0 = Label(window, text="ARTISTS - MIKE SHINODA",font='Helvetica 16 bold' ,bg="gray84") #GIVING THE WINDOW A TITLE SO THE USER/CLIENT KNOWS WHAT MENU THEY ARE ON 
...
l1 = Label(window, text="""Michael Kenji Shinoda is an American musician,
singer, songwriter, rapper, record producer, and graphic designer.
He co-founded Linkin Park in 1996 and is the band's rhythm guitarist,
primary songwriter, keyboardist, producer, and lead vocalist.
...
def option1():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\ARTISTS\\ALBUMS - MIKE SHINODA\\PT.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
...
window.title("MIKE SHINODA MAIN MENU - MSTR")    #GIVING THE WINDOW A TITLE THAT WILL BE AT THE VERY TOP ALONGSIDE THE '- O X' BUTTONS 

...
l0 = Label(window, text="ARTISTS - THE GAME",font='Helvetica 16 bold' ,bg="gray84") #GIVING THE WINDOW A TITLE SO THE USER/CLIENT KNOWS WHAT MENU THEY ARE ON 
...
l1 = Label(window, text="""Jayceon Terrell Taylor, better known by his stage name
The Game, is an American rapper and actor. He is best known as a
rapper in the West Coast hip hop scene and for being one of
Dr. Dre's signees under Aftermath Records.
...
def option1():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\ARTISTS\\ALBUMS - THE GAME\\R.E.D.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy() #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU

b1 = Button(window, text=" THE GAME - R.E.D ", command=option1) #CREATING THE BUTTON AND ADDING THE ARTIST AND ALBUM NAME
...
window.title("THE GAME MAIN MENU - MSTR")    #GIVING THE WINDOW A TITLE THAT WILL BE AT THE VERY TOP ALONGSIDE THE '- O X' BUTTONS 

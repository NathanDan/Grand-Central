...
l0 = Label(window, text="ARTISTS - BEADY EYE",font='Helvetica 16 bold' ,bg="gray84") #GIVING THE WINDOW A TITLE SO THE USER/CLIENT KNOWS WHAT MENU THEY ARE ON 
...
l1 = Label(window, text="""Beady Eye were an English rock band formed in 2009
by lead vocalist Liam Gallagher, guitarists Gem Archer and Andy Bell,
and drummer Chris Sharrock, all former members of Oasis. In 2013,
former Kasabian guitarist Jay Mehler joined the band
playing bass guitar on tour.
...
def option1():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\ARTISTS\\ALBUMS - BEADY EYE\\BE.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
...
window.title("BEADY EYE MAIN MENU - MSTR")    #GIVING THE WINDOW A TITLE THAT WILL BE AT THE VERY TOP ALONGSIDE THE '- O X' BUTTONS 

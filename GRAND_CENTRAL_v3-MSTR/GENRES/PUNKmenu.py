#TKinter GC GENRES (PUNK ROCK) - MSTR
#2019
#Nathan Jones
...
l0 = Label(window, text="PUNK ROCK MENU",font='Helvetica 16 bold' ,bg="gray84") #GIVING THE WINDOW A TITLE SO THE USER/CLIENT KNOWS WHAT MENU THEY ARE ON 
...
l1 = Label(window, text="""Punk rock (or "punk") is a rock music genre that developed
in the mid-1970s in the United States, United Kingdom,
and Australia. Rooted in 1960s garage rock and
other forms of what is now known as "proto-punk"
music, punk rock bands rejected perceived excesses
of mainstream 1970s rock.
...
def option1():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - PR\\California.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
...
def option2():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - PR\\GH.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy()                                                                                                                             #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU
...
window.title("PUNK ROCK MENU - MSTR")           #GIVING THE WINDOW A TITLE THAT WILL BE AT THE VERY TOP ALONGSIDE THE '- O X' BUTTONS 
window.geometry("400x380")                         #GENERATING THE SIZE OF THE WINDOW 

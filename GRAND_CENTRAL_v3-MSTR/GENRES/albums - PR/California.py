...
l0 = Label(window, text="",bg="lightblue")
l0.pack()

album = ImageTk.PhotoImage(Image.open("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - PR\\California.jpg"))
...
b1 = Button(window, text="                Kings Of The Weekend            ", command=option9)
b1.pack()
...
def option16():
    ...
    song.play()
    time.sleep(30)
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - PR\\California.py")
    window.destroy()
    pyglet.app.run()
...
def option14():
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\PUNKmenu.py")
    window.destroy()

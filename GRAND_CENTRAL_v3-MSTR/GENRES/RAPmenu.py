#TKinter GC GENRES (HIP HOP) - MSTR
#2019
#Nathan Jones
...
l0 = Label(window, text="HIP HOP MENU",font='Helvetica 16 bold' ,bg="gray84") #GIVING THE WINDOW A TITLE SO THE USER/CLIENT KNOWS WHAT MENU THEY ARE ON 
...
l1 = Label(window, text="""Hip hop music, also called hip-hop or rap music,
is a music genre developed in the United States by inner-city
African Americans in the late 1970s which consists of
a stylized rhythmic music that commonly accompanies
...
def option1():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - RAP\\2001.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
...
def option2():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - RAP\\DC.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy()                                                                                                                             #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU

b1 = Button(window, text="Ice Cube - Death Certificate", command=option2)     #CREATING THE BUTTON AND ADDING THE ARTIST AND ALBUM NAME
b1.pack()                                                                                 #DISPLAYING THE BUTTON ON THE MENU       

def option3():

    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - RAP\\R.E.D.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy()                                                                                                                             #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU

b1 = Button(window, text="         The Game - R.E.D         ", command=option3)     #CREATING THE BUTTON AND ADDING THE ARTIST AND ALBUM NAME
b1.pack()                                                                                 #DISPLAYING THE BUTTON ON THE MENU       
...
window.title("HIP HOP MENU - MSTR")           #GIVING THE WINDOW A TITLE THAT WILL BE AT THE VERY TOP ALONGSIDE THE '- O X' BUTTONS 

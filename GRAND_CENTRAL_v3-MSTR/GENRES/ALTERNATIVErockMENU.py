#TKinter GC GENRES (ALTERNATIVE ROCK) - MSTR
#2019
#Nathan Jones
...
l0 = Label(window, text="ALTERNATIVE ROCK MENU",font='Helvetica 16 bold' ,bg="gray84") #GIVING THE WINDOW A TITLE SO THE USER/CLIENT KNOWS WHAT MENU THEY ARE ON 
...
l1 = Label(window, text="""Alternative rock is a style of rock music that
emerged from the independent music underground of the 1980s
and became widely popular in the 1990s.
In this instance, the word "alternative" refers to the
genre's distinction from mainstream rock music.
...
def option1():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - AR\\BE.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy()                                                                                                                       #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU

b1 = Button(window, text="                             Beady Eye - BE                                    ", command=option1)         #CREATING THE BUTTON AND ADDING THE ARTIST AND ALBUM NAME
b1.pack()                                                                                 #DISPLAYING THE BUTTON ON THE MENU 


def option2():

    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - AR\\BFS.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy()                                                                                                                             #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU

b1 = Button(window, text="Bowling For Soup - The Songs People Actualy Liked", command=option2)     #CREATING THE BUTTON AND ADDING THE ARTIST AND ALBUM NAME
b1.pack()                                                                                 #DISPLAYING THE BUTTON ON THE MENU

def option3():

    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\GENRES\\albums - AR\\1ML.py") #TAKING THE USER/CLIENT TO THEIR ALBUM THEY HAVE SELECTED
    window.destroy()                                                                                                                             #CLOSING THE WINDOW AUTOMATICALLY AS THEY LEAVE THE MENU

b1 = Button(window, text="                    Linkin Park - One More Light                    ", command=option3)     #CREATING THE BUTTON AND ADDING THE ARTIST AND ALBUM NAME
b1.pack()                                                                                 #DISPLAYING THE BUTTON ON THE MENU  
...
window.title("ALTERNATIVE ROCK MENU - MSTR")           #GIVING THE WINDOW A TITLE THAT WILL BE AT THE VERY TOP ALONGSIDE THE '- O X' BUTTONS 

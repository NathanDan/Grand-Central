...
def option20():
    ...
    os.startfile("C:\\Users\\natda\\OneDrive\\Sixth Form\\Computer Science\\CODE\GRAND CENTRAL v3\\GRAND_CENTRAL_v3-MSTR\\albums\\1l.py") #REFRESHES THE CURRENT ALBUM PAGE AFTER ALL SONGS HAVE PLAYED 
    window.destroy()
    pyglet.app.run()
